...
func QueryRow(uow repoquery.UnitOfWork, query string, args ...interface{}) pgx.Row {
...
func Exec(uow repoquery.UnitOfWork, query string, args ...interface{}) (pgconn.CommandTag, error) {
	uowPg := uow.(*unitOfWork)
	if uowPg.tx != nil {
